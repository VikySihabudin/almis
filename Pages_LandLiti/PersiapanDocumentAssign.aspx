<%@ Page Language="C#" MasterPageFile="~/MasterPages/mptamp.master" AutoEventWireup="true" CodeFile="PersiapanDocumentAssign.aspx.cs" Inherits="Pages_LandLiti_PersiapanDocumentAssign" %>
...
<h2>Assign Persiapan Dokumen</h2>  
<hr />
<br />
<div class="form-group">
    ...
    <div class="col-md-1"><asp:Button runat="server" id="a" Text="Back" class="btn btn-lg btn-success" PostBackUrl="~/Pages_LandLiti/PersiapanDocumentList.aspx" />
    </div> 
...
<br />
        ...
        <div class="form-group">
            ...
            <div style=" width:100%; height:400px;">
                <div id="gridPerDuk" style=" width:100%; height:100%; background-color:white; border: 1px solid #A4BED4"></div>
                <div id="pagePerDuk"> </div>
            </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var localURL = "PersiapanDocumentAssign.aspx";
   // var newURL = "PersiapanDocumentAssign.aspx?param1=I";
    ...
    function listPersiapanDocument() {
        listPersiapanDocument = new dhtmlXGridObject('gridPerDuk');
        listPersiapanDocument.setImagePath("../JavaScript/codebase/imgs/");
        listPersiapanDocument.setHeader("No,No Persiapan Document,No klaim,Nama,Kabupaten,Kecamatan,Desa ,Nama Perusahaan,Assign,Status,Action");
        listPersiapanDocument.setInitWidths("50,180,150,150,150,150,140,140,140,140,62");
        listPersiapanDocument.setColAlign("left,left,left,left,left,left,left,left,left,left,center");
        listPersiapanDocument.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,ed,ed,ch");
        listPersiapanDocument.attachEvent("onCheckbox", doOnCheck);
        listPersiapanDocument.init();
        listPersiapanDocument.setSkin("dhx_skyblue");

        listPersiapanDocument.setColSorting("str,str,str,str,str,str,str,str,str,str,str");
        listPersiapanDocument.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPersiapanDocument.enablePaging(true, 15, 5, "pagePerDuk", true);
    ...
    function doOnCheck(rowId, cellInd, state) {
        ...
        if (state == 0) {
            var r = confirm("Batalkan Assign Kepada " + listPersiapanDocument.cells(rowId, 8).getValue() + " ?");
            if (r == true) {
