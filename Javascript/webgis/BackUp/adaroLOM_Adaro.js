...
//          }
          ...
          findTask = new FindTask("http://192.168.204.82:6080/arcgis/rest/services/LOM/MapServer/");
          ...
          _lankomInfoTemplate.setContent("${PID}<br>" +
              _lankomInfoContent);
          var lankom = new ArcGISDynamicMapServiceLayer("http://192.168.204.82:6080/arcgis/rest/services/LOM/MapServer/",
          {
              "opacity": 100,
              visible: true
          });
