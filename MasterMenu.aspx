<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/mpBootstrap.master" AutoEventWireup="true" CodeFile="MasterMenu.aspx.cs" Inherits="Pages_MasterMenu" %>
...
<hr />
		...
		<div class="form-group" >
            ...
            <div class="col-sm-2">
                ...
                <asp:DropDownList ID="ddprg" runat="server" class="form-control input-lg" onclick="handleClick()">
                </asp:DropDownList>
            </div>
