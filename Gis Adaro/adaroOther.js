...
//          }
          ...
          findTask = new FindTask("http://192.168.204.27:6080/arcgis/rest/services/P2016/MapServer");
          ...
          _lankomInfoTemplate.setContent("${PID}<br>" +
              _lankomInfoContent);
          var lankom = new ArcGISDynamicMapServiceLayer("http://192.168.204.27:6080/arcgis/rest/services/P2016/MapServer",
          {
              "opacity": 100,
              visible: true
          });
