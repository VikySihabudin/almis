...
//          }
          ...
          findTask = new FindTask("http://192.168.204.27:6080/arcgis/rest/services/TOP/MapServer/");
          ...
          _lankomInfoTemplate.setTitle("<b>Top Priority</b>");
          ...
          _lankomInfoTemplate.setContent("${Nama}<br>" +
              _lankomInfoContent);
          var lankom = new ArcGISDynamicMapServiceLayer("http://192.168.204.27:6080/arcgis/rest/services/TOP/MapServer/",
          {
              "opacity": 100,
              visible: true
          });
