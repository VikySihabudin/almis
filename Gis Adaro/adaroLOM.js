...
//          }
          ...
          findTask = new FindTask("http://192.168.204.27:6080/arcgis/rest/services/Inventory1/MapServer/");
          ...
          // Dynamic layer
          // var lankom = new ArcGISDynamicMapServiceLayer("http://192.168.204.27:6080/arcgis/rest/services/Inventory1/MapServer/1",{
          //   "opacity" : 0,
          //   visible : true
          // });

          var _lankomInfoTemplate = new InfoTemplate();
          _lankomInfoTemplate.setTitle("<b>LOM</b>");
          ...
          _lankomInfoTemplate.setContent("${OBJECTID}<br>" +
              _lankomInfoContent);
          var lankom = new ArcGISDynamicMapServiceLayer("http://192.168.204.27:6080/arcgis/rest/services/Inventory1/MapServer/",
          {
              "opacity": 100,
              visible: true
          });
