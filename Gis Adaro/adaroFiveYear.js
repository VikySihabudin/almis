...
//          }
          ...
          findTask = new FindTask("http://192.168.204.27:6080/arcgis/rest/services/SY/MapServer/");
        ...
        //  Dynamic layer
        // var lankom = new ArcGISDynamicMapServiceLayer("http://192.168.204.27:6080/arcgis/rest/services/SY/MapServer/0",{
        //    "opacity" : 0,
        //    visible : true
        //  });

          var _lankomInfoTemplate = new InfoTemplate();
          _lankomInfoTemplate.setTitle("<b>Five Year</b>");
          var _lankomInfoContent =
            "<div class=\"demographicInfoContent\">" +
           " <br>Registrasi : ${OBJECTIDKA}" +
            "<br>Status Lahan : ${Status_Lhn}" +
            "<br>Nama : ${Nama}" +
            "<br>Tanggal Pngk : ${Tgl_Survey}" +
            "<br>Desa : ${Desa}" +
            "<br>Kecamatan : ${Kecamatan}" +
            "<br>TKabupaten : ${Kabupaten}" +
            "</div>";

          _lankomInfoTemplate.setContent("${Nama}<br>" +
              _lankomInfoContent);
          var lankom = new ArcGISDynamicMapServiceLayer("http://192.168.204.27:6080/arcgis/rest/services/SY/MapServer/",
          {
              "opacity": 100,
              visible: true
          });
