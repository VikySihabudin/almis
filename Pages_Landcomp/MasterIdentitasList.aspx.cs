...
public partial class Pages_MasterIdentitasList : System.Web.UI.Page
{
    ...
    private void HakAkses()
    {
        ...
        MasterIdentitasEdit = dt.Rows[11]["MasterIdentitasEdit"].ToString(); //0
        MasterIdentitasDelete = dt.Rows[11]["MasterIdentitasDelete"].ToString(); //1
        MasterIdentitasView = dt.Rows[11]["MasterIdentitas"].ToString(); //2
