...
public partial class Pages_RegistrasiList : System.Web.UI.Page
{
    ...
    private void HakAkses()
    {
        ...
        RegistrasiEdit = dt.Rows[2]["RegistrasiEdit"].ToString(); //0
        RegistrasiDelete = dt.Rows[2]["RegistrasiDelete"].ToString(); //1
        RegistrasiView = dt.Rows[2]["Registrasi"].ToString(); //2
